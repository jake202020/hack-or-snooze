...
class StoryList {
   ...
   */
	...
	// *********************
	// The call to the api for stories should be the same regardless of the
	// instance that is bring used on a page
	// *********************
   ...
   */
	...
	async addStory(user, newStory) {
		...
		// make a new story instance for this new story
		newStory = new Story(response.data.story);

		// add this new story to the top of the stories list
		this.stories.unshift(newStory);

		// add this new story to the top of the user's stories list
	...
	/**
   * make a DELETE request to remove a particular story and update the StoryList
   *
   ...
   */
	...
	async removeStory(user, storyId) {
		...
		// remove story with ID we are removing
